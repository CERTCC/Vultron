...
def executing_actor_id(request):
    ...
    follows its executing actor (ADR-0071) — so declaring the actor once keeps the
...
class TestEmitRMGapNoteNode:
    ...
    store follows its executing actor (BT-05-005, ADR-0071), and the node
