...
def executing_actor_id(request):
    ...
    follows its executing actor (ADR-0069) — so declaring the actor once keeps the
...
class TestEmitRMGapNoteNode:
    ...
    store follows its executing actor (BT-05-005, ADR-0069), and the node
