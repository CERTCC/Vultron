...
class TestActorIdScoping:
    """Every DataLayer belongs to exactly one actor (ADR-0072)."""
...
class TestOutboxIsPerActorStore:
    ...
    cross-actor write it enabled is gone (ADR-0072).
...
class TestGetDatalayerFactory:
    ...
    def test_every_instance_carries_the_actor_it_was_asked_for(self):
        ...
        was ``None``.  That was the shared DataLayer, and ADR-0072 deletes it:
