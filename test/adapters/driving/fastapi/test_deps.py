...
(ADR-0071). ARCH-13-003's own wording still names ``ActorScopedDataLayer`` and
...
# hosted actor is named base_url + "actors/" + slug (ADR-0071). An id under
...
def test_one_actor_has_exactly_one_queue_regardless_of_spelling() -> None:
    """BUG-2026040901 is structurally impossible now (ADR-0071).
