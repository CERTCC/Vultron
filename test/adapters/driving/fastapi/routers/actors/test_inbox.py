...
Tests inbox processing helpers in isolation from the HTTP layer. The storage
helpers moved to ``inbox_storage`` (#3705); their tests are in
``test/adapters/driving/fastapi/test_inbox_storage.py``.
"""
