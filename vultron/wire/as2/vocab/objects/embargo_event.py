#!/usr/bin/env python
"""
Wire-layer alias for EmbargoEvent.
...
as_EmbargoEvent = EmbargoEvent

# Register core class in WIRE_TYPE_MAP so the parser admits it inline
WIRE_TYPE_MAP["EmbargoEvent"] = EmbargoEvent

as_EmbargoEventRef: TypeAlias = ActivityStreamRef[EmbargoEvent]
