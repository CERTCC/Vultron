...
ENTRIES: list[SemanticEntry] = [
    ...
    SemanticEntry(
        ...
        phrase="{actor} accepted the case proposal",
        wire_activity_class=None,
        include_activity=True,
    ),
    SemanticEntry(
        ...
        phrase="{actor} declined the case proposal",
        wire_activity_class=None,
        include_activity=True,
    ),
    SemanticEntry(
