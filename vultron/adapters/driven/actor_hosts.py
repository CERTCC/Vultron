...
This is the one legitimately node-level fact left after ADR-0069 removed the
...
def canonical_actor_uri(segment: str, base_url: str | None = None) -> str:
    ...
    This replaces the pre-ADR-0069 approach of scanning every actor row in a
...
def storage_ready(db_url: str | None = None) -> bool:
    ...
    store. Before ADR-0069 this was answered by ``ping()`` on the shared
