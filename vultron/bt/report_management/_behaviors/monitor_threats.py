...
_NoticeAttack = sequence_node("_NoticeAttack", """This node represents the process of noticing an attack on a vulnerability covered by a report.
    ...
    """, MonitorAttacks, q_cs_to_A, EmitCA)


_MoveToCsPublic = sequence_node("_MoveToCsPublic", """This node represents the process of moving the case state to the PUBLIC_AWARE state.
    Steps:
...
_EnsureCsInPublic = fallback_node("_EnsureCsInPublic", """This node represents the process of ensuring that the case state is in the PUBLIC_AWARE state. If the case state
    ...
    """, CSinStatePublicAware, _MoveToCsPublic)


_NoticeExploit = sequence_node("_NoticeExploit", """This node represents the process of noticing the public availability of an exploit for a vulnerability covered by
    ...
    """, MonitorExploits, _EnsureCsInPublic, q_cs_to_X, EmitCX)


_NoticePublicReport = sequence_node("_NoticePublicReport", """This node represents the process of noticing the public availability of a report for a vulnerability covered by a
    ...
    """, MonitorPublicReports, _MoveToCsPublic)
...
_EndEmbargoIfEventsWarrant = sequence_node("_EndEmbargoIfEventsWarrant", """This node represents the process of ending the embargo if the events warrant it.
    ...
    """, _MonitorExternalEvents, TerminateEmbargoBt)


MonitorThreats = fallback_node("MonitorThreats", """This node represents the process of monitoring threats to a report being coordinated by the case.
    It monitors for attacks, exploits, and public reports while the case is being coordinated.
    ...
    """, _EndEmbargoIfEventsWarrant, NoThreatsFound)
