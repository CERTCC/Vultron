...
_AssignIdIfPossible = sequence_node("_AssignIdIfPossible", """This node attempts to assign an ID to the vulnerability if possible.
    Steps:
    ...
    """, IsIDAssignmentAuthority, IdAssignable, AssignId)


_AssignOrRequestId = fallback_node("_AssignOrRequestId", """This node attempts to assign an ID to the vulnerability or request an ID from the ID assignment authority.
    Steps:
    ...
    """, _AssignIdIfPossible, RequestId)


_AssignIdIfInScope = sequence_node("_AssignIdIfInScope", """This node attempts to assign a vulnerability ID to the vulnerability if it is in scope.
    Steps:
    ...
    If any of these steps fail, the vulnerability is not assigned an ID.
    """, InScope, _AssignOrRequestId)


AssignVulID = fallback_node("AssignVulID", """This node attempts to assign a vulnerability ID to the vulnerability.
    Steps:
