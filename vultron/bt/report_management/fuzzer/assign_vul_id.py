#!/usr/bin/env python
"""file: assign_identity
author: adh
created_at: 2/21/23 2:15 PM
"""
...
class IdAssigned(btz.UsuallyFail):
...
class InScope(btz.UsuallySucceed):
...
class RequestId(btz.UsuallySucceed):
...
class IsIDAssignmentAuthority(btz.OftenSucceed):
...
class IdAssignable(btz.ProbablySucceed):
...
class AssignId(btz.AlwaysSucceed):
