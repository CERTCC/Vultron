...
_CloseOrPrioritize = fallback_node(
    "CloseOrPrioritize",
...
_PrioritizeDoWork = sequence_node(
    "PrioritizeDoWork",
...
_CloseOrPrioritizeOrWork = fallback_node(
...
ReportManagementBt = fallback_node(
    "ReportManagementBt",
