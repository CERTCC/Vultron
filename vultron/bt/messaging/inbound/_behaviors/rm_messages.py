...
_RecognizeVendorNotifiedIfNecessary = fallback_node(
...
_ChooseRmMsgReaction = fallback_node(
...
_HandleAckableRmMessage = sequence_node(
...
_HandleRmMessage = fallback_node(
    "_HandleRmMessage",
...
ProcessRMMessagesBt = sequence_node(
    "ProcessRMMessagesBt",
