...
_MaybeExitWhenDeployed = sequence_node(
...
_MaybeExitWhenFixReady = sequence_node(
...
_OtherReasonToExitEmbargo = fallback_node(
...
_AvoidNewEmbargoesInCsDeployedUnlessReason = fallback_node(
...
_AvoidCounterProposal = sequence_node(
...
_ProposeNewEmbargo = sequence_node(
    "ProposeNewEmbargo",
...
_ProposeEmbargoRevision = sequence_node(
...
_ConsiderProposingEmbargo = fallback_node(
...
_ProposeEmbargoBt = sequence_node(
    "ProposeEmbargoBt",
    """Propose an embargo.
    Steps:
...
_SufficientCauseToAbandonProposedEmbargo = fallback_node(
...
_SufficientCauseToTerminateActiveEmbargo = fallback_node(
...
_ConsiderTerminatingActiveEmbargo = sequence_node(
...
_EnsureSufficientEffortToAchieveEmbargo = fallback_node(
...
_AvoidNewEmbargoWhenNotInCs_pxa = sequence_node(
...
_EvaluateAndAcceptProposedEmbargo = sequence_node(
...
_CounterEmbargoProposal = sequence_node(
...
_RejectProposedEmbargo = sequence_node(
...
_ChooseEmProposedResponse = fallback_node(
...
_ChooseEmActiveResponse = fallback_node(
...
_ChooseEmReviseResponse = fallback_node(
...
EmbargoManagementBt = fallback_node(
    "EmbargoManagementBt",
