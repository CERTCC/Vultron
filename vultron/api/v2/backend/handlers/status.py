...
def create_case_status(dispatchable: DispatchEvent, dl: DataLayer) -> None:
    uc.create_case_status(dispatchable.payload, dl)
...
def create_participant_status(
    ...
    uc.create_participant_status(dispatchable.payload, dl)
