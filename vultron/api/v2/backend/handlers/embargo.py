...
def create_embargo_event(dispatchable: DispatchEvent, dl: DataLayer) -> None:
    uc.create_embargo_event(dispatchable.payload, dl)
...
def invite_to_embargo_on_case(
    ...
    uc.invite_to_embargo_on_case(dispatchable.payload, dl)
