...
9. Perform a gap analysis to identify gaps, ambiguities, and redundancy
...
10. Review `specs/project-documentation.md` to understand the intended 
    ...
    content for each.
11. Refine specs/* to clarify, split, merge, or remove requirements as needed.
    2. Ensure each requirement is atomic, specific, concise, and verifiable.
    3. Avoid prescribing implementation details in specs; focus on what must be achieved, not how.
    4. Use PROD_ONLY tag for requirements that only apply to production.
    5. Organize specs/* into one topic-per-file where that improves clarity.
    6. Update specs/README.md to reflect the any changes in spec files
12. Refine notes/* to capture critical insights, design tradeoffs, and open  
...
13. Refine AGENTS.md to update any recurring agent guidance or process rules as needed.
    1. Ensure guidance is precise, actionable, terse, and minimal.

### Ensure quality, consistency, and alignment across documentation

13. Ensure quality and consistency across modified files, including:
...
14. Propagate changes across files as needed to maintain consistency and
    ...
    1. Run a repository-wide text search for the keywords that motivated
       ...
       duplicates.
15. If you cannot resolve a conflicting requirement or you suspect an
...
16. You are not required to run tests for markdown-only edits.

### Finalize and commit changes

17. Git add and commit changes with a clear commit message.
