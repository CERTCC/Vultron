# manage-github-issue — API Reference

Full GraphQL examples, idempotency implementation, API discovery commands,
and issue type constants for the `manage-github-issue` skill.

For the quick-start interface and usage, see `SKILL.md`.
