...
A case is a collection of information about a particular
report or set of reports; a note is a comment on
that information. The following example shows a note being added to a case.
...
!!! note "Add vs Create+Target"
    ...
    a Note with the Case as the target. `as:Add` represents
