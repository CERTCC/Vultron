...
- The `Role` flags are consistent with the roles we defined in [Terms and Definitions](../reference/terms.md), as taken from the [CVD Guide](https://certcc.github.io/CERT-Guide-to-CVD){:target="_blank"}.
