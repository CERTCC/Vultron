...
We address [report validation]((./rm_validation_bt/) shortly, but, for now, it is
...
$q^{rm} \xrightarrow{c} C$, as described in [report closure]((./rm_closure_bt)), or retry the validation.

For reports that have reached the *Valid* state ($q^{rm} \in V$), our
only action is to prioritize the report. [Report prioritization]((./rm_prioritization_bt) is
...
in [Do Work Behaviors]((./do_work_bt/).
...
See also:
- [Report Validation Behavior]((./rm_validation_bt/)
- [Report Prioritization Behavior]((./rm_prioritization_bt/)
- [Report Closure Behavior]((./rm_closure_bt/)
