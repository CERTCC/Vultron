...
We are still working through the children of [Receive Messages]((./msg_intro_bt/) behavior tree.
...
termination tree]((./em_terminate_bt/).
...
Rather, such follow-up would be expected to occur as part of the Participant's [*do work* process]((./do_work_bt/).
