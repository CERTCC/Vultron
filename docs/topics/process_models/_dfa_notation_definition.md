???+ note inline end "DFA Notation Defined"
    ...
    A [Deterministic Finite Automaton](https://en.wikipedia.org/wiki/Deterministic_finite_automaton){:target="_blank"} is defined as a 5-tuple $(\mathcal{Q},q_0,\mathcal{F},\Sigma,\delta)$ where
