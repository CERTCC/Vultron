...
history is recorded and shared. It also explains how control of the case can
...
- :material-swap-horizontal: [Ownership Transfer](ownership_transfer.md) —
  how the `CASE_OWNER` role moves between participants via the Case Actor
