...
## 2026-03-26 Replicated Log Synchronization notes
...
## 2026-03-26 Capture interaction between triggers, received messages, and sync in notes

Participants do triggers, case actor catches the messages emitted as a  
result and updates the case state accordingly, and sync ensures the case
state is consistent across all participants). Clarify that
