...
→ captured in `notes/state-machine-findings.md`
...
→ captured in `AGENTS.md` (Agent Quickstart)
...
→ noted in `AGENTS.md` (complete per AGENTS.md)
...
→ captured in `AGENTS.md`, `notes/architecture-ports-and-adapters.md`
...
→ already in `AGENTS.md` (repo_memories)
