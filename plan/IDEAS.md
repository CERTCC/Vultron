...
→ `NonEmptyString` adoption captured in `specs/code-style.md` CS-08-001/CS-08-002;
`OptionalNonEmptyString` removal captured as TECHDEBT-26 in `plan/IMPLEMENTATION_PLAN.md`
...
example.~~
→ captured as TECHDEBT-23 (`TriggerRequest` base class) and TECHDEBT-25 (`_as_id()` helper)
