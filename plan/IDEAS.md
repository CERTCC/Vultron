...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (TOOLS-1)
...
→ captured in `specs/code-style.md` (CS-07-003), `AGENTS.md`,
`plan/IMPLEMENTATION_PLAN.md` (NAMING-1)
...
→ captured in `specs/tech-stack.md` (IMPL-TS-07-006), `AGENTS.md`,
`plan/IMPLEMENTATION_PLAN.md` (QUALITY-1)
...
→ captured in `plan/IMPLEMENTATION_HISTORY.md` (header), `AGENTS.md`
...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (SECOPS-1)
...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (DOCMAINT-1)
...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (D5-1 updated)
...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (SYNC-1 through SYNC-4),
...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (REORG-1)
...
→ captured in `plan/IMPLEMENTATION_PLAN.md` (DOCS-3)
