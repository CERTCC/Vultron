...
Finding 1 (RequireCaseOwnerApproval default) is tracked as #2812. Finding 2 (verify_replica_state TOCTOU) is tracked as #2714. Finding 3 (calve-epics running before orient-agent) was fixed in this audit — bugfix/SKILL.md Phase 1 now invokes orient-agent before the epic match. PR #2775 was never a tracking reference.
