...
Resolved. `manage_github_issue.sh` now supports `--issue-type-id`, used successfully in this audit to file #3038, #3039, and #3041. The GraphQL workaround this entry documents is obsolete.
