...
decision record (ADR-0079) and two new spec groups.
...
- `docs/adr/0079-case-ledger-causal-ordering.md` — normative decision record
- `specs/case-ledger-processing.yaml` (v1.2.0 → v1.3.0): CLP-14 (9 entries) and
  CLP-15 (5 entries)
- `specs/multi-actor-demo.yaml`: DEMOMA-22-005 mis-citation fixed (ADR-0041 → ADR-0079)
- `notes/case-ledger-authority.md`: forward reference to ADR-0079 added
