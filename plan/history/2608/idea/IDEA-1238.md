...
- Added DEMOMA-25 group (6 specs: DEMOMA-25-001 through DEMOMA-25-006) to
  ...
  final state, and CI/test obligations (renumbered from DEMOMA-24; DEMOMA-24
  was claimed by the FCVD scenario on main before this PR landed)
- Added DEMOMA-16-015 specifying the VC scenario's required case-actor event
