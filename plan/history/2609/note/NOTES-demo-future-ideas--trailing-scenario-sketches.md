---
source: NOTES-demo-future-ideas--trailing-scenario-sketches
timestamp: '2026-09-17T17:21:03.993163+00:00'
title: Demo scenario prose sketches (FV / Three-Actor / MultiParty)
type: note
---

**Archived:** 2026-09-17
**Reason:** (b) superseded by the structured scenario table (file own 2026-07-06 note); all 9 scenarios exist under vultron/demo/scenario/
**Superseded by:** notes/demo-future-ideas.md § Implemented scenarios; vultron/demo/scenario/
