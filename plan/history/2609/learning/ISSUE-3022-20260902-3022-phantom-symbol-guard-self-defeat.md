...
**Promoted**: 2026-09-03 — captured in `notes/spec-authoring-rules.md` ("A Grep-Corpus Guard Can Resolve Its Own Documentation"). Docs PR: <https://github.com/CERTCC/Vultron/pull/3147>.
