...
All four findings filed by a later session: #2964 (_coerce_vf_or_none / _coerce_d_or_none KeyError), #2965 (peer VF assertion silently accepted), #2966 (EmitCaseStatusUpdateNode case_id=''). PR #2928 was never a tracking reference.
